...
<body>
  <header>
    <div class="logo">NICE<span>PRO</span> <span style="font-size:10px; color:#fff; background:#ff0000; padding:2px 4px; border-radius:2px; margin-left:4px">v9.11 NUCLEAR (API FIX)</span></div>
